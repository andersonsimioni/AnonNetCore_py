...
\begin{equation}
    proof = SHA512(canonical\_payload\_material \parallel nonce)
\end{equation}
...
\begin{equation}
    logical\_key = \texttt{virtual\_node\_id|profile}
\end{equation}

The physical DHT key is derived from this logical key:

\begin{equation}
    dpt\_key = SHA512(\texttt{dpt|virtual\_node\_id|profile})
\end{equation}
