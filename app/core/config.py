...
class CoreConfig:
    ...
    physical_ping_runtime_interval_seconds: float = 1.0
    ...
    virtual_route_maintenance_interval_seconds: float = 1.0
    ...
    default_random_walk_ttl_ms: int = 100

    network_pow_difficulty_bits: int = 8

    session_keepalive_seconds: int = 20
    session_runtime_interval_seconds: float = 1.0
